...
@Component({
  ...
  styleUrls: ['./trouve.page.scss'],
})
export class TrouvePage implements OnInit {
  public slideOpts = {
    slidesPerView: 1,
    spaceBetween:1,
    initialSlide:1,
...
cp: number = 1;
  ...
  nombre: any;
  indice: boolean;
  constructor(private srvc : NotificationServiceService,private route : Router, private service : TrouveServiceService, public alertController: AlertController) {}
  ngOnInit(): void {
    this.getAnnonce();
    this.getAnnonce();
