...
@Component({
  ...
  styleUrls: ['./perdu.page.scss'],
})
export class PerduPage implements OnInit {
  public slideOpts = {
    slidesPerView: 1,
    spaceBetween:1,
    initialSlide:1,
  ...
  nombre: any;
  indice: boolean;
  constructor(private srvc : NotificationServiceService,private route :Router, public alertController: AlertController ,private service :PerduServiceService) {}
